...
$('.contraste').click(function(){
    ...
    $(".card").toggleClass('sup-contraste');
    $(".alert-primary").toggleClass('sup-contraste');
    $(".buble").toggleClass('sup-contraste');
    $("footer").toggleClass('sup-contraste');
    $(".bi").toggleClass('sup-contraste');  
});